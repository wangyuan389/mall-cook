<!--
 * @Description: 商品分类模板配置
 * @Autor: WangYuan
 * @Date: 2021-09-08 19:37:59
 * @LastEditors: June
 * @LastEditTime: 2023-03-10 01:12:40
-->
<template>
...
export default {
  ...
  methods: {
    getImage() {
      return this.categoryTpl.advertising ? new URL(`../../../assets/image/pc-template-category-advert.jpg`, import.meta.url).href : new URL(`../../../assets/image/pc-template-category-base.jpg`, import.meta.url).href
    },
  },
};
</script>
