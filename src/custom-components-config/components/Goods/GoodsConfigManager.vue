 ...
 * @LastEditTime: 2021-09-07 17:08:48
-->
<template>
  <div>
    <div class="nav">
      ...
      >
        ...
        <div class="flex">
          <!-- <div
            ...
            class="flex-center h50 w50 mr10 shadow"
          >
            <van-image :src="item.cover" />
          </div>
          <div
            class="flex-center h50 w50 shadow pointer"
            @click="editActiveList(group)"
          >
            +
          </div> -->
          <GoodsConfigList
