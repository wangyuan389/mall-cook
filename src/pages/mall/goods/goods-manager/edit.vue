 ...
 * @LastEditTime: 2021-09-28 20:23:37
-->
<template>
    ...
    >
      ...
      >
        <el-input
          ...
          style="width:500px"
        ></el-input>
        <div class="f12 f-grey">在商品详情页标题下面展示卖点信息，建议60字以内</div>
      </el-form-item>
      <el-form-item
        label="商品封面："
        prop="cover"
      ...
      >
        <Imgpond
          ...
          :count="10"
        />
        <div class="f12 f-grey">建议尺寸：800*800像素，你可以拖拽图片调整顺序，最多上传10张</div>
      </el-form-item>
      <el-form-item
        label="价格："
        prop="price"
...
export default {
  created() {
    ...
    form.originalPrice = form.originalPrice / 100;
    this.form = form;
  },
  data() {
    return {
  ...
  methods: {
    ...
    formatParams(target) {
      let data = this._.cloneDeep(target);
      // 价格为统一为分
